...
fprintf(['¡Muy buenas! Bienvenid@s a la resolución numérica de la Ecuación de Schrödinger. \n' ...
    'Para lo que sigue, se recomienda utilizar los siguientes valores para los intervalos \n' ...
    'con el fin de evitar desfases en las funciones: \n\n' ...
    'Pozo infinito: a=0, b>0. \n' ...
    'Pozo finito: a<-5, b>5. \n' ...
    'Oscilador cuántico: a<-8, b>8 (para una mejor visualización). \n\n' ...
    '¡Un saludo!\n\n']);
